...
1. **Austin 獨創概念**：如「曝險」「場外全壘打」「大象起舞」等非通用金融術語
2. **本集會提到的人名/公司名**：如 Howard Marks、NIKE、NFLX、LULU
3. **英文專有名詞及其中文對照**：如 Ivy Portfolio→常春藤投資組合、slugging percentage→長打率
4. **本集特定的金融術語**：如再平衡、周轉率、13F 持倉報告

抽取規則：
- 只抽 ASR 可能聽錯的詞（冷門術語、英文混搭、Austin 獨創用語）
- 不抽通用常見詞（「股票」「債券」「投資」等 ASR 不會錯的）
- 與 `terms_austin_v2.txt` 比對，已有的不重複列出
